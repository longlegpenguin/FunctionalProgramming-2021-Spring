...
// no restritions of negative data input at this point yet.
...
// Start = turn_into_list 1235 // [1,2,3,5]
// Start = turn_into_list 12004 // [1,2,0,0,4]

is_palindrome :: Int -> Bool
is_palindrome x
| x < 0 = False  // all negative numbers are not palindome because of the - sign
= turn_into_list x  == reverse (turn_into_list x) 
...
// Start = is_palindrome 1010101 // True          