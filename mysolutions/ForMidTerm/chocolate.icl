...
chocolateAux :: Int Int -> Int
chocolateAux 0 _ = 0
chocolateAux x wrap = x/wrap + chocolateAux (x/2) wrap

chocolate :: Int Int Int -> Int
chocolate money price wrap = money/price + chocolateAux (money/price) wrap

// Start = chocolate 16 2 2