...
// Start = inorder Atree //[1,2,3,4]
// Start = preorder Atree // [4,2,1,3]
// Start = postorder Atree //[1,3,2,4]
...
// Start = IsEqual {nom = 9, den = 10} QOne
...
arrSt = {{id=1,uni=Elte,grades=[5]}, {id=2,uni=BME,grades=[5,5]}, {id=3,uni=Corvinus,grades=[5,5,5]}}

Start = moreThanNGrades arrSt 2 //[(3,Corvinus)]
Start = moreThanNGrades arrSt 1 //[(2,BME),(3,Corvinus)]
