...
/*
1. Given an array of Student-s, return array of those student's name
who have average GPA greater than 4.0.
*/

selectStudent :: {Student} ->{String}
selectStudent sts = {x.name \\ x <-: sts | f x}
where
    g x = (toReal (sum x.grades)) / (toReal (length x.grades))
    f x = g x > 4.0


// Start = selectStudent {Rose,Harry,Isabella} // {"Rose","Isabella"}
// Start = selectStudent {Oliver, Noah,James,Lily} // {"James"}
// Start = selectStudent {Peter,Rose,Eros} // {"Rose"}
// Start = selectStudent {Rose,Harry,Isabella,Oliver,James,Noah,Lily,Peter,Eros} // {"Rose","Isabella","James"}
